...
func (AdminConfigProjectHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (AdminConfigProjectHttpPlugin) GetName() string {
        return "AdminConfigProjectHttpPlugin"
}

func (AdminConfigProjectHttpPlugin) GetStage() string {
        return "open"
}
