...
func (ConfigurationEnvAwsHttpPlugin) GetRequests() []l9format.WebPluginRequest {
...
func (ConfigurationEnvAwsHttpPlugin) GetName() string {
        return "ConfigurationEnvAwsHttpPlugin"
}

func (ConfigurationEnvAwsHttpPlugin) GetStage() string {
        return "open"
}
...
func (plugin ConfigurationEnvAwsHttpPlugin) Verify(request l9format.WebPluginRequest, response l9format.WebPluginResponse, event *l9format.L9Event, options map[string]string) (hasLeak bool) {
        ...
        if match {
                ...
                event.Summary = "Found sensitive information in /configuration/.env:\n" + string(response.Body)
                return true
        }
